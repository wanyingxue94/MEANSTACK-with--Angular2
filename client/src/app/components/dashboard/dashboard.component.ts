...
export class DashboardComponent implements OnInit {
  ...
  onBlogSubmit() {
    ...
    this.dashboardService.newBlog(blog).subscribe(data => {
  ...
  getAllBlogs() {
    // Function to GET all blogs from database
    this.dashboardService.getAllBlogs().subscribe(data => {
  ...
  postComment(id) {
    ...
    this.dashboardService.postComment(id, comment).subscribe(data => {
